            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-SlipperOrder">
                            <thead>
                                <tr>
                                    <th width="10">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="search">
                                            <option value>{{ trans('global.all') }}</option>
                                            @foreach($slipper_options as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-SlipperOrder:not(.ajaxTable)').DataTable({ buttons: dtButtons })
