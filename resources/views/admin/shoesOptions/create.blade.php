        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.shoesOption.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.shoes-options.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="picker">
                            <div class="form-group">
                                <label for="color">{{ __('لون الحذاء') }}</label>
                            ...
                            <div class="form-group">
                                <label for="size">{{ __('مقاس الحذاء') }}</label>
                            ...
                            <div class="form-group">
                                <label for="type">{{ __('نوع الحذاء') }}</label>
